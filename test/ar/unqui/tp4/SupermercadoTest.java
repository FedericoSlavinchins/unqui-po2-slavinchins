...
public class SupermercadoTest {
	...
	public void setUp() {
		...
		detergente = new Producto();
		detergente.setNombre("Detergente");
		detergente.setPrecio(75d);
	...
	public void testPrecioTotal() {
		assertEquals(/*new Double(0),*/supermercado.getPrecioTotal(), 0d);
		supermercado.agregarProducto(arroz);
		supermercado.agregarProducto(detergente);
		assertEquals(/*new Double(93.9),*/ supermercado.getPrecioTotal(), 93,9d);
	}
}
